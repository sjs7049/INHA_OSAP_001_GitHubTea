...
int AVLTree::Difference(Node* temp) {
  ...
  */
  int leftHeight =
      temp->get_left_node() ? temp->get_left_node()->get_height() : 0;
  int rightHeight =
      temp->get_right_node() ? temp->get_right_node()->get_height() : 0;
...
void AVLTree::UpdateHeight(Node* n) {
  ...
  */
  if (n != nullptr) {
    int leftHeight =
        (n->get_left_node()) ? n->get_left_node()->get_height() : 0;
    int rightHeight =
        (n->get_right_node()) ? n->get_right_node()->get_height() : 0;
